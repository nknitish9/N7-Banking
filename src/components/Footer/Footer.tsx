...
const Footer = () => {
  const [footerRef, footerVisible] =
    useIntersectionObserver<HTMLElement>({ threshold: 0.08 });

  return (
    <footer
      className={`footer ${footerVisible ? "footer--visible" : ""}`}
      ref={footerRef}
    >
      {/* GLOW EFFECTS */}
      ...
      <div className="footer-content">
        {/* LEFT — BRAND */}
        <div
          className={`footer-brand ${footerVisible ? "footer-brand--visible" : ""}`}
        >
          <img
            src="/svg/n7-logo.svg"
            alt="N7 Logo"
        ...
        <div className="footer-right">
          <div className="footer-columns">
            ...
            <div className="footer-column">
              <div
                className={`footer-address ${footerVisible ? "footer-address--visible" : ""}`}
          ...
          {/* COPYRIGHT */}
          <div
            className={`footer-copyright ${footerVisible ? "footer-copyright--visible" : ""}`}
          >
